...
export const services: Service[] = [
  {
    ...
    formSchema: [
      ...
      {
        name: "requestedEmail",
        label: "Email yang Diminta",
        type: "email",
        required: true,
        placeholder: "contoh@tangerangkota.go.id",
      },
      {
        name: "reason",
        ...
        type: "textarea",
        required: true,
        placeholder: "Jelaskan alasan pengajuan email",
      },
    ],
  },
  {
    ...
    formSchema: [
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Jelaskan alasan pengajuan TTE",
      },
    ],
  },
  {
    ...
    description:
      "Akses aman ke jaringan internal Pemerintah Kota Tangerang untuk mendukung pekerjaan dari jarak jauh",
    category: "infrastruktur",
    icon: "Shield",
    route: "/services/vpn",
    details: {
      description:
        "Layanan Virtual Private Network (VPN) Pemerintah Kota Tangerang memungkinkan akses aman ke jaringan internal pemerintah dari lokasi manapun. Dengan enkripsi tingkat tinggi, layanan ini memastikan keamanan dan kerahasiaan data selama transmisi.",
      benefits: [
    ...
    formSchema: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: "Diskominfo Kota Tangerang",
            label: "Diskominfo Kota Tangerang",
          },
  ...
  },
  {
    ...
    formSchema: [
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Jelaskan tujuan subdomain",
      },
      {
        name: "pic",
  ...
  },
  {
    ...
    formSchema: [
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Daftar email anggota tim (pisahkan dengan koma)",
      },
      {
        name: "description",
  ...
  },
  {
    ...
    formSchema: [
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Daftar email yang dapat mengakses (pisahkan dengan koma)",
      },
      {
        name: "purpose",
        label: "Tujuan Penggunaan",
        type: "textarea",
        required: true,
        placeholder: "Jelaskan tujuan penyimpanan",
      },
    ],
  },
  {
    ...
    formSchema: [
      {
        name: "systemAffected",
        label: "Sistem/Aplikasi Terdampak",
        type: "text",
        required: true,
        placeholder: "Nama sistem yang mengalami masalah",
      },
      {
        name: "incidentDate",
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: "critical",
            label: "Kritis - Dampak luas pada layanan publik",
          },
        ],
      },
      {
